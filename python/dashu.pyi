...
class UBig:
    ...
    # available when built with the "zeroize" feature
...
# cross-type comparison utilities (exact, backed by num-order's NumOrd)
def compare(a: Number, b: Number) -> int: ...
def min(a: Number, b: Number) -> Number: ...
def max(a: Number, b: Number) -> Number: ...


# --- optional third-party integrations (available only when built with the matching feature) ---

class serde:
    @staticmethod
    def to_json(obj: Number) -> str: ...
    @staticmethod
    def from_json(cls: type, s: str) -> Number: ...
    @staticmethod
    def serialize(obj: Number) -> bytes: ...
    @staticmethod
    def deserialize(cls: type, data: bytes) -> Number: ...


class rand:
    @staticmethod
    def ubig(bits: int) -> UBig: ...
    @staticmethod
    def ibig(bits: int) -> IBig: ...
    @staticmethod
    def fbig(precision: Optional[int] = ...) -> FBig: ...
    @staticmethod
    def dbig(precision: Optional[int] = ...) -> DBig: ...
    @staticmethod
    def rbig(max_denom_bits: int = ...) -> RBig: ...
    @staticmethod
    def cbig(precision: Optional[int] = ...) -> CBig: ...


class rkyv:
    @staticmethod
    def to_bytes(obj: Number) -> bytes: ...
    @staticmethod
    def from_bytes(cls: type, data: bytes) -> Number: ...
