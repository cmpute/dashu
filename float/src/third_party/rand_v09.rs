//! Random floating point number generation with the `rand` crate (0.9.x).
//!
...
//!
//! ```
//! use dashu_float::rand_v09::Uniform01;
...
//! * [UniformFBig] (and therefore [Uniform][rand_v09::distr::Uniform]) will generate floats
...
use dashu_int::{
    rand_v09::{UniformBelow, UniformBits},
    DoubleWord, UBig,
};
use rand_v09::{
    distr::{
