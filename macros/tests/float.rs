...
fn test_fbig() {
    ...
    assert_eq!(
        fbig!(0x5a4653ca673768565b41f775d6947d55cf3813d1p-200).precision(),
        160
    );
    assert_eq!(
    ...
    assert_eq!(
        fbig!(0x5a4653ca673768565b41f0000000000000000000p-200).precision(),
        160
    );
...
fn test_dbig() {
    ...
    assert_eq!(
        dbig!(515377520732011331036461129765621272702107522001e-100).precision(),
        48
    );
    assert_eq!(
    ...
    assert_eq!(
        dbig!(515377520732011331036461100000000000000000000000e-100).precision(),
        48
    );
