//! Random integers generation with the `rand` crate (0.10.x).
//!
...
//! # use rand_v010::{distr::uniform::Uniform, rng, Rng, RngExt};
//! use dashu_base::BitTest;
//! use dashu_int::rand_v010::{UniformBits, UniformBelow};
//!
...
///
/// See the module ([rand_v010][crate::rand_v010]) level documentation for examples.
