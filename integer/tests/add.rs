...
fn test_add_sub_ubig() {
    let test_cases = [
        ...
        (
            ...
            ubig!(2),
            ubig!(0x100000000000000000000000000000001),
        ),
        (
            ubig!(0x88888888888888888888888888888888),
            ubig!(0x88888888888888888888888888888888),
            ubig!(0x111111111111111111111111111111110),
        ),
        (
            ubig!(0x888888888888888888888888888888888888888888888888),
            ubig!(0x88888888888888888888888888888888),
            ubig!(0x888888888888888911111111111111111111111111111110),
        ),
        (
            ubig!(0x888888888888888888888888888888888888888888888888),
            ubig!(0),
...
fn test_add_sub_ibig() {
    let test_cases = [
        ...
        (
            ...
            ibig!(0x200000000000000010000000000000000),
        ),
        (
            ibig!(-0x200000000000000010000000000000000),
            ibig!(0x200000000000000000000000000000000),
...
fn test_add_sub_ubig_ibig() {
    let test_cases = [
        ...
        (
            ubig!(0x200000000000000010000000000000000),
            ibig!(-0x200000000000000000000000000000000),
            ibig!(0x10000000000000000),
        ),
    ];
